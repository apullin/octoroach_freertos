...
//Default gains
#ifdef PID_SOFTWARE
#define LEG_CTRL_DEFAULT_KP  200
#define LEG_CTRL_DEFAULT_KI  5
#define LEG_CTRL_DEFAULT_KD  0
#define LEG_CTRL_DEFAULT_KAW 5
#define LEG_CTRL_DEFAULT_KFF  0
#define SOFT_GAIN_SCALER 512
#elif defined PID_HARDWARE
#define LEG_CTRL_DEFAULT_KP  15000
#define LEG_CTRL_DEFAULT_KI  500
#define LEG_CTRL_DEFAULT_KD  150
#define LEG_CTRL_DEFAULT_KAW 0
#define LEG_CTRL_DEFAULT_KFF  0
